    ...
    <div>
        ...
        <div className="flex justify-start items-center  max-md:flex-wrap">
          <div className=" my-auto text-4xl font-semibold text-black leading-[53px] tracking-[2.16px]">
            <span className="text-xl line-through mr-4">{oldPrice ? (currentLocation ? currentLocation.split(' ')[1] : '€') : ""}{oldPrice}</span>
            <span className="text-3xl mr-4">{currentLocation ? currentLocation.split(' ')[1] : '€'}{price}</span>
          </div>
